package nilsobergContigFilter::nilsobergContigFilterServer;
...
our %return_counts = (
        'run_nilsobergContigFilter' => 1,
        'run_nilsobergContigFilter_max' => 1,
        'status' => 1,
);

our %method_authentication = (
        'run_nilsobergContigFilter' => 'required',
        'run_nilsobergContigFilter_max' => 'required',
);
...
sub call_method {
    ...
    my $ctx = nilsobergContigFilter::nilsobergContigFilterServerContext->new($self->{loggers}->{userlog},
...
{
    # Service nilsobergContigFilter requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for nilsobergContigFilter but no authentication header was passed");
	}
    ...
    my @result;
    {
        ...
        my $stderr = nilsobergContigFilter::nilsobergContigFilterServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service nilsobergContigFilter.");
    }
...
package nilsobergContigFilter::nilsobergContigFilterServerContext;

use strict;

=head1 NAME

nilsobergContigFilter::nilsobergContigFilterServerContext
...
package nilsobergContigFilter::nilsobergContigFilterServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = nilsobergContigFilter::nilsobergContigFilterServer->new(
